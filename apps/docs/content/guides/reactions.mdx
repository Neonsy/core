...
Runnable bots: [reaction-bot](/examples/reaction-bot/) (logging) and [reaction-roles-bot](/examples/reaction-roles-bot/) (`!roles` posts the picker). Short-lived prompts: [Collectors](/guides/collectors/).
