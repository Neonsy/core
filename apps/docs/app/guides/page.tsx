...
export default function GuidesIndexPage(): React.ReactElement {
  ...
  return (
    <PageShell sidebarTitle="Guides" sidebarGroups={getGuidesSidebarGroups()} wide>
      <header className="mb-14">
        <p className="mb-3 font-mono text-xs uppercase tracking-wider text-primary/80">
          Fluxer.js 2.0 · {totalGuides} guides
        </p>
