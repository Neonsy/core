...
import { cdnAvatarURL, cdnBannerURL, cdnDefaultAvatarURL } from '../Helpers/Cdn.js';
import type { MessagePrepareInput } from '../Helpers/MessageUtils/index.js';
import { Base } from './Base.js';
import { DMChannel } from './Channel/index.js';
...
export class User extends Base {
  ...
  constructor(client: Client, data: APIUserPartial & { banner?: string | null }) {
    super();
    this.client = client;
    this.id = data.id;
  ...
  /** @internal */
  _patch(data: APIUserPartial & { banner?: string | null }): void {
    this.username = data.username;
    this.discriminator = data.discriminator;
    this.globalName = data.global_name ?? null;
    this.avatar = data.avatar ?? null;
