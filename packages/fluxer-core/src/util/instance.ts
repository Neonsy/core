...
export function parseInstanceDiscovery(raw: unknown): APIInstance {
  ...
  return {
    ...
    endpoints,
    ...(raw.captcha !== undefined ? { captcha: raw.captcha as APIInstance['captcha'] } : {}),
    ...(raw.features !== undefined ? { features: raw.features as APIInstance['features'] } : {}),
    ...(raw.gif !== undefined ? { gif: raw.gif as APIInstance['gif'] } : {}),
    ...(raw.sso !== undefined ? { sso: raw.sso as APIInstance['sso'] } : {}),
    ...(raw.registration !== undefined
    ...
    ...(raw.community !== undefined
      ...
      : {}),
    ...(raw.services !== undefined ? { services: raw.services as APIInstance['services'] } : {}),
    ...(raw.limits !== undefined ? { limits: raw.limits as APIInstance['limits'] } : {}),
    ...(raw.push !== undefined ? { push: raw.push as APIInstance['push'] } : {}),
    ...(raw.app_public !== undefined
